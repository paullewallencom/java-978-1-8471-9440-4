...
public class BankAgency extends TransformComponentSupport{

    private static final Log log = LogFactory.getLog(BankAgency.class);
    ...
    protected boolean transform(MessageExchange exchange, NormalizedMessage in, NormalizedMessage out) throws MessagingException {
        ...
        System.out.println("BankAgency.transform. correlationId                            : " + correlationId);
		...
		if(content instanceof StreamSource){
			...
			log.debug("BankAgency-content.getClass() : " + content.getClass() + " ; content : " + content);
		}

        out.setProperty(Constants.CREDIT_AUTHORIZED_KEY, new Boolean(true));
        return true;
    }
}
