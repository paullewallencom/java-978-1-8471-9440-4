...
public class XMLUtil{
    ...
    public static String retreiveSoapContent(Node node){
		...
		try {
			...
			//items = body.getChildElements(envelope.createName("Body", "env", "http://schemas.xmlsoap.org/soap/envelope/"));
			//bodyElement = (SOAPBodyElement) items.next();

			//contentNode = body.getNextSibling();
